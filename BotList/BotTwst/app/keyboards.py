...
async def inline_list(productss, ticked=False):
	...
	logging.debug("whole keyboard ", keyboard.adjust(3).as_markup())
...
async def inline_list2(_keybord):
	...
	#logging.debug("whole keyboard2 ", new_keyboard.adjust(3).as_markup())
